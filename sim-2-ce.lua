...
handle drawingObjectHandle = sim.addDrawingObject(int objectType, float size = 1.0, float duplicateTolerance = 0.0, int parentObjectHandle = -1, int maxItemCount = 1000, float[3] color = {0.0, 0.0, 0.0})
...
int result = sim.cameraFitToView(int viewHandleOrIndex, handle[] objectHandles=nil, int options=0, float scaling=1.0)
...
map[] originalColorData = sim.changeEntityColor(handle entityHandle, color newColor, int colorComponent=sim.colorcomponent_ambient_diffuse)
