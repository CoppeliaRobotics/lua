...
sim.addItemToCollection(handle collectionHandle, int what, handle objectHandle, int options)
...
sim.setObjectSel(handles objectHandles)
handles objectHandles = sim.getObjectSel()
...
... = sim.callScriptFunction(handle scriptHandle, string functionName, ...)
int result = sim.cameraFitToView(int viewHandleOrIndex, handles objectHandles = {}, int options = 0, float scaling = 1.0)
...
pose p = sim.getObjectPose(handle objectHandle, handle relativeToObjectHandle = sim.handle_world)
vector3 pos = sim.getObjectPosition(handle objectHandle, handle relativeToObjectHandle = sim.handle_world)
quaternion quat = sim.getObjectQuaternion(handle objectHandle, handle relativeToObjectHandle = sim.handle_world)
sim.setObjectPose(handle objectHandle, pose p, handle relativeToObjectHandle = sim.handle_world)
...
bool result, int[2] collidingObjects = sim.checkCollision(handle entity1Handle, handle entity2Handle)
bool result, float dist, vector3 p1, vector3 p2, int[2] objectHandlePair = sim.checkDistance(handle entity1Handle, handle entity2Handle, float threshold=0.0)
...
handles copiedObjectHandles = sim.copyPasteObjects(handles objectHandles, int options = 0)
...
int handle = sim.createProximitySensor(int sensorType, int subType = 16, int options = 0, int[8] intParams = nil, float[15] floatParams = nil)
int handle = sim.createShape(int options, float shadingAngle, float[] vertices, int[] indices, float[] normals, float[] textureCoordinates, buffer texture, int[2] textureResolution)
int handle, int textureId, int[2] resolution = sim.createTexture(string fileName, int options, float[2] planeSizes=nil, float[2] scalingUV=nil, float[2] xy_g=nil, int fixedResolution=0, int[2] resolution=nil)
int handle = sim.createVisionSensor(int options, int[4] intParams, float[11] floatParams)
