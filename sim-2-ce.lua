...
sim.auxiliaryConsoleClose(int consoleHandle)
...
sim.auxiliaryConsolePrint(int consoleHandle, string text)
sim.auxiliaryConsoleShow(int consoleHandle, bool showState)
