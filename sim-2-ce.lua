...
bool result, int[2] collidingObjects = sim.checkCollision(handle entity1Handle, handle entity2Handle = sim.handle_all)
bool result, float dist, vector3 p1, vector3 p2, int[2] objectHandlePair = sim.checkDistance(handle entity1Handle, handle entity2Handle = sim.handle_all, float threshold = 0.0)
