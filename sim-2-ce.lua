...
handle[] copiedObjectHandles = sim.copyPasteObjects(handle[] objectHandles, int options = 0)
...
int result, any value = sim.executeScriptString(string stringToExecute, handle scriptHandle)
...
handle[] objectHandles = sim.getCollectionObjects(handle collectionHandle)
...
handle childObjectHandle = sim.getObjectChild(handle objectHandle, int index)
...
sim.removeObjects(handle[] objectHandles, bool delayedRemoval=false)
