...
int previousLockLevel=sim.setAutoYield(bool automaticSwitch)
int previousLockLevel=sim.setAutoYield(int forbidLevel)
bool result,int lockLevel=sim.getAutoYield()
bool allowed=sim.getYieldAllowed()
int forbidLevel=sim.setYieldAllowed(bool allowed)
int forbidLevel=sim.setYieldAllowed(int forbidLevel)
...
bool exit=sim.getThreadExistRequest()
...
buffer data=sim.packCbor(any item,bool doublePrecision=true)
...
int result=sim.pauseSimulation()
