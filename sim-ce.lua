...
bool pValue = bool getBoolProperty(int target, string pName)
sim.setInt32Property(int target, string pName, int pValue)
int pValue = getInt32Property(int target, string pName)
sim.setFloatProperty(int target, string pName, float pValue)
float pValue = getFloatProperty(int target, string pName)
sim.setStringProperty(int target, string pName, string pValue)
string pValue = getStringProperty(int target, string pName)
sim.setBufferProperty(int target, string pName, buffer pValue)
buffer pValue = getBufferProperty(int target, string pName)
sim.setTableProperty(int target, string pName, map pValue, map options)
map pValue = getTableProperty(int target, string pName)
sim.setVector3Property(int target, string pName, float[3] pValue)
float[3] pValue = getVector3Property(int target, string pName)
sim.setQuaternionProperty(int target, string pName, float[4] pValue)
float[4] pValue = getQuaternionProperty(int target, string pName)
sim.setPoseProperty(int target, string pName, float[7] pValue)
float[7] pValue = getPoseProperty(int target, string pName)
sim.setMatrixProperty(int target, string pName, float[12] pValue)
float[12] pValue = getMatrixProperty(int target, string pName)
sim.setColorProperty(int target, string pName, float[3] pValue)
float[3] pValue = getColorProperty(int target, string pName)
sim.setVectorProperty(int target, string pName, float[] pValue)
float[] pValue = getVectorProperty(int target, string pName)
