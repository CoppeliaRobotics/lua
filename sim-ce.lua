...
int scriptHandle = sim.createScript(int scriptType, string scriptString, int options = 0)
...
buffer data, string dataType = sim.readCustomDataBlockEx(int handle, string tagName, map options={})
