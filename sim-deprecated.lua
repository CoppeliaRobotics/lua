...
deprecated.functions = {
    ...
    {"sim.clearDoubleSignal", "sim.clearFloatSignal"},
    {"sim.clearIntegerSignal", "sim.clearInt32Signal"},
    {"sim.closeModule", ""},
    ...
    {"sim.getArrayParameter", "sim.getArrayParam"},
    {"sim.getBoolParameter", "sim.getBoolParam"},
    ...
    {"sim.getDoubleSignal", "sim.getFloatSignal"},
    {"sim.getEngineBoolParameter", "sim.getEngineBoolParam"},
    {"sim.getEngineFloatParameter", "sim.getEngineFloatParam"},
    {"sim.getEngineInt32Parameter", "sim.getEngineInt32Param"},
    {"sim.getFloatParameter", "sim.getFloatParam"},
    {"sim.getIkGroupHandle", "the simIK functionality"},
    {"sim.getIkGroupMatrix", "the simIK functionality"},
    {"sim.getInt32Parameter", "sim.getInt32Param"},
    {"sim.getIntegerSignal", "sim.getInt32Signal"},
    ...
    {"sim.getObjectFloatParameter", "sim.getObjectFloatParam"},
    ...
    {"sim.getObjectStringParameter", "sim.getObjectStringParam"},
    ...
    {"sim.getScriptAttribute", "sim.getScriptInt32Param or sim.getScriptStringParam"},
    ...
    {"sim.getStringParameter", "sim.getStringParam"},
    ...
    {"sim.readCustomDataBlock", "sim.readCustomStringData"},
    {"sim.readCustomDataBlockTags", "sim.readCustomDataTags"},
    ...
    {"sim.sendData", ""},
    {"sim.setArrayParameter", "sim.setArrayParam"},
    {"sim.setBoolParameter", "sim.setBoolParam"},
    {"sim.setCollectionName", ""},
    {"sim.setConfigurationTree", ""},
    {"sim.setDebugWatchList", ""},
    {"sim.setDoubleSignal", "sim.setFloatSignal"},
    {"sim.setEngineBoolParameter", "sim.setEngineBoolParam"},
    {"sim.setEngineFloatParameter", "sim.setEngineFloatParam"},
    {"sim.setEngineInt32Parameter", "sim.setEngineInt32Param"},
    {"sim.setFloatParameter", "sim.setFloatParam"},
    ...
    {"sim.setInt32Parameter", "sim.setInt32Param"},
    {"sim.setIntegerSignal", "sim.setInt32Signal"},
    {"sim.setJointForce", "sim.setJointTargetForce"},
    {"sim.setJointMaxForce", "sim.setJointTargetForce"},
    {"sim.setObjectConfiguration", ""},
    {"sim.setObjectFloatParameter", "sim.setObjectFloatParam"},
    {"sim.setObjectInt32Parameter", "sim.setObjectInt32Param"},
    {"sim.setObjectName", "sim.setObjectAlias"},
    {"sim.setObjectSelection", "sim.setObjectSel"},
    {"sim.setObjectSizeValues", ""},
    {"sim.setObjectStringParameter", "sim.setObjectStringParam"},
    {"sim.setScriptAttribute", "sim.setScriptInt32Param or sim.setScriptStringParam"},
    ...
    {"sim.setStringParameter", "sim.setStringParam"},
