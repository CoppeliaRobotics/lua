...
function _S.sysCallEx_init()
    ...
    sim.registerScriptFunction('sim.waitForSignal@sim','int/float/buffer sigVal=sim.waitForSignal(string sigName)')
    ...
    sim.registerScriptFunction('sim.readCustomTableData@sim','any[]/map data=sim.readCustomTableData(int objectHandle,string tagName)')
    sim.registerScriptFunction('sim.writeCustomTableData@sim','sim.writeCustomTableData(int objectHandle,string tagName,any[]/map data)')
    sim.registerScriptFunction('sim.getObject@sim','int objectHandle=sim.getObject(string path,map options)')
    sim.registerScriptFunction('sim.getObjectFromUid@sim','sim.getObjectFromUid(string path,map options)')
